...
## [0.3.17](https://github.com/GroupTherapyOrg/WasmTarget.jl/compare/v0.4.0...v0.3.17) (2026-06-29)
...
* 13 newly fixed, 0 still open. Full Pkg.test green.
* strict-by-default soundness + differential combinatorial fuzzer (0.2.0)

### verify_gaps

* 13 newly fixed, 0 still open. Full Pkg.test green. ([c7bf70a](https://github.com/GroupTherapyOrg/WasmTarget.jl/commit/c7bf70a2f5e0d2b7a943fc2706cdea301fd5c7de))
...
* compile Core.kwcall invokes through to kwarg bodies (Statistics pilot) ([6872b76](https://github.com/GroupTherapyOrg/WasmTarget.jl/commit/6872b76a9bf95fdb896208aef461642883aa87c7))
...
* narrow right-shift input normalisation, catchable math domain errors, ([c7bf70a](https://github.com/GroupTherapyOrg/WasmTarget.jl/commit/c7bf70a2f5e0d2b7a943fc2706cdea301fd5c7de))
...
* union-of-Vectors wasm representation + array_subpadding host-fold (Statistics median/quantile path) ([00c3009](https://github.com/GroupTherapyOrg/WasmTarget.jl/commit/00c30094d213f7a4c62fe70749510796e809aba3))
