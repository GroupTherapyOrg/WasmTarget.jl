#!/usr/bin/env julia
#
# PURE-500: IR Audit Script — Catalog All Patterns Parsestmt Needs
#
# Walks the full dependency graph of parsestmt(Expr, String) using
...
#
# Output: scripts/ir_audit_results.json
#
...
# Custom logger to capture stub warnings
...
function generate_output()
    ...
    outpath = joinpath(@__DIR__, "ir_audit_results.json")
...
function main()
    println("=== PURE-500: IR Audit Script ===")
    println("Auditing IR patterns for parsestmt(Expr, String)...")
    println()
    ...
    walk_dependencies!(parse_expr_string, (String,))
