...
src_01(x::Int64) = x * x + Int64(1)
src_02(x::Int64, y::Int64) = x + y
src_03(x::Int64) = x * Int64(3) - Int64(7)
src_04(x::Int64, y::Int64) = x * y + Int64(10)
src_05(x::Int64) = x * x * x
src_06(x::Int64, y::Int64) = x * x - y * y
src_07(x::Int64) = (x + Int64(1)) * (x - Int64(1))
src_08(x::Int64, y::Int64) = Int64(2) * x + Int64(3) * y
src_09(x::Int64) = x
src_10(x::Int64, y::Int64, z::Int64) = x + y + z
...
_make_entry(:p01, src_01, (Int64,))
_make_entry(:p02, src_02, (Int64, Int64))
_make_entry(:p03, src_03, (Int64,))
_make_entry(:p04, src_04, (Int64, Int64))
_make_entry(:p05, src_05, (Int64,))
_make_entry(:p06, src_06, (Int64, Int64))
_make_entry(:p07, src_07, (Int64,))
_make_entry(:p08, src_08, (Int64, Int64))
_make_entry(:p09, src_09, (Int64,))
_make_entry(:p10, src_10, (Int64, Int64, Int64))
