...
(*   s9  PhiCNode                                -- Known; quarantine tier      *)
(*      (NirPhiC) -- was Unsupported before the FINDING was closed              *)
(*   s10 UpsilonNode                             -- Known; quarantine tier      *)
(*      (NirUpsilon) -- a real `local.set` lowering, never a no-op              *)
(*   s11 ExprGcPreserveBegin                     -- Known; quarantine tier      *)
(*      (NirNoOp) -- real in `GC.@preserve` IR, see NirBuild.tla's FINDING      *)
(*   s12 ExprLoopinfo                            -- Known; quarantine tier      *)
(*      (NirNoOp) -- real in `@simd` IR                                         *)
