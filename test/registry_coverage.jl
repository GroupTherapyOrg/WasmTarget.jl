...
const ALLOWLIST = Dict{Tuple{Symbol,String},String}(
    ...
    (:BUILTIN_LOWERINGS, "_expr") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    ...
    (:BUILTIN_LOWERINGS, "donotdelete") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    ...
    (:BUILTIN_LOWERINGS, "length") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:BUILTIN_LOWERINGS, "memoryref") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:BUILTIN_LOWERINGS, "memoryref_isassigned") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    ...
    (:BUILTIN_LOWERINGS, "typeof") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:FOREIGN_LOWERINGS, "jl_alloc_genericmemory") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:FOREIGN_LOWERINGS, "jl_id_char") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:FOREIGN_LOWERINGS, "jl_id_start_char") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    ...
    (:FOREIGN_LOWERINGS, "jl_is_operator") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:FOREIGN_LOWERINGS, "jl_is_syntactic_operator") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:FOREIGN_LOWERINGS, "jl_module_name") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:FOREIGN_LOWERINGS, "jl_module_parent") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:FOREIGN_LOWERINGS, "jl_ptr_to_array_1d") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:FOREIGN_LOWERINGS, "jl_type_intersection") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    ...
    (:FOREIGN_LOWERINGS, "strlen") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    ...
    (:INTRINSIC_BINOPS, "(F32, F32, :max_float_fast)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_BINOPS, "(F32, F32, :min_float_fast)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    ...
    (:INTRINSIC_BINOPS, "(F64, F64, :max_float_fast)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_BINOPS, "(F64, F64, :min_float_fast)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_BINOPS, "(I32, I32, :ne_int)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_BINOPS, "(I32, I32, :sdiv_int)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_BINOPS, "(I32, I32, :srem_int)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_BINOPS, "(I32, I32, :udiv_int)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_BINOPS, "(I32, I32, :urem_int)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_BINOPS, "(I64, I64, :ne_int)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_BINOPS, "(I64, I64, :sdiv_int)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_BINOPS, "(I64, I64, :srem_int)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_BINOPS, "(I64, I64, :udiv_int)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_BINOPS, "(I64, I64, :urem_int)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_CONVERSIONS, "(F32, I32, :fptoui)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_CONVERSIONS, "(F32, I64, :fptosi)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_CONVERSIONS, "(F32, I64, :fptoui)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_CONVERSIONS, "(F64, I32, :fptosi)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_CONVERSIONS, "(F64, I32, :fptoui)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_CONVERSIONS, "(I32, F32, :bitcast)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_CONVERSIONS, "(I32, F32, :sitofp)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_CONVERSIONS, "(I32, F32, :uitofp)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    ...
    (:INTRINSIC_CONVERSIONS, "(I64, F32, :sitofp)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_CONVERSIONS, "(I64, F32, :uitofp)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_CONVERSIONS, "(I64, I32, :trunc_int)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_UNOPS, "(F32, :ceil_llvm)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_UNOPS, "(F32, :floor_llvm)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_UNOPS, "(F32, :neg_float)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_UNOPS, "(F32, :rint_llvm)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_UNOPS, "(F32, :sqrt_llvm)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_UNOPS, "(F32, :sqrt_llvm_fast)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_UNOPS, "(F32, :trunc_llvm)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_UNOPS, "(F64, :sqrt_llvm_fast)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    (:INTRINSIC_UNOPS, "(I32, :ctpop_int)") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
    ...
    (:STANDALONE_INTRINSIC_BODIES, "_generate_rethrow_standalone_body") => "unexercised when the lane was created (2026-09-22) — Phase 12 item M",
)
