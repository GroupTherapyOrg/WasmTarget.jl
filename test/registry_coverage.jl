...
const ALLOWLIST = Dict{Tuple{Symbol,String},String}(
    ...
    (:INVOKE_INTRINSICS, "_invoke_add_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_array_subpadding_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — Base.array_subpadding is overlaid (interpreter.jl:821), so its MethodInstances belong to the overlay Method)",
    (:INVOKE_INTRINSICS, "_invoke_error_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_getindex_continued_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — inlined into getindex(::String, ::Int))",
    (:INVOKE_INTRINSICS, "_invoke_isascii_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — inlined)",
    (:INVOKE_INTRINSICS, "_invoke_kwerr_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_length_str_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — inlined; a dynamic length(::String) compiles as a dispatch candidate)",
    (:INVOKE_INTRINSICS, "_invoke_mul_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_neg_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_nextind_continued_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_padding_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_parse_float_literal_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — a direct call inlines, and Meta.parse's closed world (38 functions) never reaches it)",
    (:INVOKE_INTRINSICS, "_invoke_parse_int_literal_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — a direct call inlines, and Meta.parse's closed world never reaches it)",
    (:INVOKE_INTRINSICS, "_invoke_print_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — print(x) compiles print(::String) as its own function, whose Base body rejects 'unresolved dynamic call Base.unsafe_write')",
    (:INVOKE_INTRINSICS, "_invoke_println_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — println(x) compiles println(::Int64) as its own function, whose Base body rejects 'unresolved dynamic call Base.print (IO, Int64, String)')",
    (:INVOKE_INTRINSICS, "_invoke_rethrow_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_show_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — show(x) compiles show(::Int64) as its own function, whose Base body rejects 'unresolved dynamic call Base.show (IO, Int64)')",
    (:INVOKE_INTRINSICS, "_invoke_sizehint_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — sizehint! inlines; invoke.jl:1767 skips the cross-call for it by name)",
    (:INVOKE_INTRINSICS, "_invoke_sizehint_kwbody_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — the keyword body inlines; invoke.jl:1767 skips the cross-call for it by name)",
    (:INVOKE_INTRINSICS, "_invoke_star_concat_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — *(::String, ::String[, ::String]) is overlaid (interpreter.jl:184, :201) and longer chains inline)",
    (:INVOKE_INTRINSICS, "_invoke_string_concat_or_reject_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — string/_string of String/Char/Symbol arguments inline)",
    (:INVOKE_INTRINSICS, "_invoke_string_eq_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — ==(::String, ::String) inlines)",
    (:INVOKE_INTRINSICS, "_invoke_string_generic_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_string_identity_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — string(::String)/string(::Symbol) inline)",
    (:INVOKE_INTRINSICS, "_invoke_string_int_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — string(::Integer; base, pad) inlines to its keyword body)",
    (:INVOKE_INTRINSICS, "_invoke_sub_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_substring_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — SubString constructors inline)",
    (:INVOKE_INTRINSICS, "_invoke_symbol_from_string_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_thisind_continued_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_throw_inexacterror_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_throw_payload_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_truncate_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_tuple_error_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
    (:INVOKE_INTRINSICS, "_invoke_typeintersect_b") => "UNREACHED (measured 2026-09-22: no :invoke of its Methods survives in the smoke and probe closed worlds or 51 more programs — typeintersect is @_total_meta and inlines to the jl_type_intersection foreigncall)",
    (:INVOKE_INTRINSICS, "_invoke_unalias_b") => "UNREACHED (measured 2026-09-22: every :invoke of its Methods in the smoke and probe closed worlds and 51 more programs targets a MethodInstance the closed world compiles, so compile_invoke!'s cross-call arm (invoke.jl:1769) takes it before the registry consult (:1935))",
)
