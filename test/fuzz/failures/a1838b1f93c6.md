...
kind: wrong_value
construct: "wrong_value: `length(string(x))` :: Int64"
...
# Gap `a1838b1f93c6` — wrong_value: `length(string(x))` :: Int64
...
## Diagnostic
```
at x=-9223372036854775808: native=20  wasm=1
```
