...
construct: "divergent_throw: `abs(Float64(lcm(Int8(1), Int8(-128))))` :: Float64"
...
# Gap `1f6c808a6d5c` — divergent_throw: `abs(Float64(lcm(Int8(1), Int8(-128))))` :: Float64
...
repro(x::Float64) = abs(Float64(lcm(Int8(1), Int8(-128))))
_x = 0.0
_c = deepcopy(_x)
...
## Diagnostic
```
at x=0.0: native=throw OverflowError  wasm=128
```
