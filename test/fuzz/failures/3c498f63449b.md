...
kind: compile_error
construct: "compile_error: `get(Dict(0 => 0.0, 0 => 0.0), 0, 0.0)` :: Float64"
...
# Gap `3c498f63449b` — compile_error: `get(Dict(0 => 0.0, 0 => 0.0), 0, 0.0)` :: Float64
...
```julia
using WasmTarget
repro(x::Float64) = get(Dict(0 => 0.0, 0 => 0.0), 0, 0.0)
...
Caused by:
    0: type mismatch: expected i64, found (ref $type) (at offset 0x317)
```
