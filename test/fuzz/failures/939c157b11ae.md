...
kind: compile_error
construct: "compile_error: `length(Dict(0 => 0, 0 => 0))` :: Int64"
...
# Gap `939c157b11ae` — compile_error: `length(Dict(0 => 0, 0 => 0))` :: Int64
...
```julia
using WasmTarget
repro(x::Int64) = length(Dict(0 => 0, 0 => 0))
...
Caused by:
    0: type mismatch: expected i64, found (ref $type) (at offset 0x2b7)
```
