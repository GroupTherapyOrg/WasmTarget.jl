...
kind: runtime_trap
construct: "runtime_trap: `isempty(Dict(string(0.5) => 0, \"\" => 0))` :: Bool"
...
# Gap `e7386f7c93fe` — runtime_trap: `isempty(Dict(string(0.5) => 0, "" => 0))` :: Bool
...
repro(x::Bool) = isempty(Dict(string(0.5) => 0, "" => 0))
_x = true
_c = deepcopy(_x)
