...
kind: compile_error
construct: "compile_error: `0.0 + median([0, 0, 0])` :: Float64"
...
# Gap `eb7455d5a630` — compile_error: `0.0 + median([0, 0, 0])` :: Float64
...
repro(x::Float64) = 0.0 + median([0, 0, 0])
...
Caused by:
    0: type mismatch: expected anyref, found i32 (at offset 0xebee)
```
