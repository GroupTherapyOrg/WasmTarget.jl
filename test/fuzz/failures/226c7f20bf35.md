...
kind: runtime_trap
construct: "runtime_trap: `length(sort(collect([0, 0, 0])))` :: Int64"
...
# Gap `226c7f20bf35` — runtime_trap: `length(sort(collect([0, 0, 0])))` :: Int64
...
repro(x::Int64) = length(sort(collect([0, 0, 0])))
