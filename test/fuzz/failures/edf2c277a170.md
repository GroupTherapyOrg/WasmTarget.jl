...
kind: runtime_trap
construct: "runtime_trap: `length(Dict(sum([Int32(0), Int32(0), Int32(0)]) => 0, Int32(0) => 0))` :: Int64"
...
# Gap `edf2c277a170` — runtime_trap: `length(Dict(sum([Int32(0), Int32(0), Int32(0)]) => 0, Int32(0) => 0))` :: Int64
...
repro(x::Int64) = length(Dict(sum([Int32(0), Int32(0), Int32(0)]) => 0, Int32(0) => 0))
_x = 0
_c = deepcopy(_x)
