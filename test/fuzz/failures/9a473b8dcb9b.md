...
kind: wrong_value
construct: "wrong_value: `Int64(last([0, 0, 1 << x]))` :: Int64"
...
# Gap `9a473b8dcb9b` — wrong_value: `Int64(last([0, 0, 1 << x]))` :: Int64
...
repro(x::Int64) = Int64(last([0, 0, 1 << x]))
