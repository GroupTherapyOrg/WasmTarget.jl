...
construct: "optimizer_unsound: `maximum(v)` :: Vector{Int64}→Int64"
...
# Gap `6fc7aa680b4c` — optimizer_unsound: `maximum(v)` :: Vector{Int64}→Int64
...
## Diagnostic
```
at v=Int64[]: native=throw ArgumentError  wasm=0
```
