...
kind: runtime_trap
construct: "runtime_trap: `maximum(sort([0, 0, 0])) == lcm(-128, -128)` :: Vector{Int64}→Bool"
...
# Gap `0143a03086b3` — runtime_trap: `maximum(sort([0, 0, 0])) == lcm(-128, -128)` :: Vector{Int64}→Bool
...
repro(v::Vector{Int64}) = maximum(sort([0, 0, 0])) == lcm(-128, -128)
function _m(a, b)
