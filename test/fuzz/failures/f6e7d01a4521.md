...
kind: compile_error
construct: "compile_error: `abs(0 + length(Dict(0 => 0, 0 => 0)))` :: Vector{Int64}→Int64"
...
# Gap `f6e7d01a4521` — compile_error: `abs(0 + length(Dict(0 => 0, 0 => 0)))` :: Vector{Int64}→Int64
...
repro(v::Vector{Int64}) = abs(0 + length(Dict(0 => 0, 0 => 0)))
function _m(a, b)
