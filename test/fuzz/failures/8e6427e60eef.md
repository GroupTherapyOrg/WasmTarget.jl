...
kind: wrong_value
construct: "wrong_value: `9223372036854775807 << x` :: Int64"
...
# Gap `8e6427e60eef` — wrong_value: `9223372036854775807 << x` :: Int64
...
repro(x::Int64) = 9223372036854775807 << x
...
## Diagnostic
```
at x=-128: native=0  wasm=9223372036854775807
```
