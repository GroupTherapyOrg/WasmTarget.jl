...
kind: runtime_trap
construct: "runtime_trap: `isempty(Dict(Int32(0) => Int('a'), sum([Int32(0), Int32(0), Int32(0)]) => 0))` :: Bool"
...
# Gap `dcdf78e15830` — runtime_trap: `isempty(Dict(Int32(0) => Int('a'), sum([Int32(0), Int32(0), Int32(0)]) => 0))` :: Bool
...
repro(x::Bool) = isempty(Dict(Int32(0) => Int('a'), sum([Int32(0), Int32(0), Int32(0)]) => 0))
_x = true
_c = deepcopy(_x)
