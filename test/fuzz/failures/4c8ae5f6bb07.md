...
kind: runtime_trap
construct: "runtime_trap: `first(map((y->asin(y)), [x, x, x]))` :: Float64"
...
# Gap `4c8ae5f6bb07` — runtime_trap: `first(map((y->asin(y)), [x, x, x]))` :: Float64
...
repro(x::Float64) = first(map((y->asin(y)), [x, x, x]))
