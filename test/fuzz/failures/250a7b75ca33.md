...
kind: runtime_trap
construct: "runtime_trap: `abs(x + first(collect([0.0, 0.0, 0.0])))` :: Float64"
...
# Gap `250a7b75ca33` — runtime_trap: `abs(x + first(collect([0.0, 0.0, 0.0])))` :: Float64
...
repro(x::Float64) = abs(x + first(collect([0.0, 0.0, 0.0])))
