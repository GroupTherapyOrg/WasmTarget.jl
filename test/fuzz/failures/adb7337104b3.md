...
kind: runtime_trap
construct: "`round(x; digits=d)` traps at runtime (WASMMAKIE W-002 locateticks)"
...
# Gap `adb7337104b3` — `round(x; digits=d)` traps at runtime (WASMMAKIE W-002 locateticks)
...
repro(x::Int64) = Int64(round(round(3.14159, digits = 2) * 100)) + x
