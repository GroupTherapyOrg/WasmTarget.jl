...
construct: "divergent_throw: `Int16(0) + (Int16(0) + Int16(0)) == lcm(Int16(32767), Int16(-32768)) + Int16(0)` :: Bool"
...
# Gap `1348263d417f` — divergent_throw: `Int16(0) + (Int16(0) + Int16(0)) == lcm(Int16(32767), Int16(-32768)) + Int16(0)` :: Bool
...
repro(x::Bool) = Int16(0) + (Int16(0) + Int16(0)) == lcm(Int16(32767), Int16(-32768)) + Int16(0)
_x = true
_c = deepcopy(_x)
