...
kind: runtime_trap
construct: "runtime_trap: `first(collect([0.0, 0.0, 0.0]))` :: Float64"
...
# Gap `6bf467b13abb` — runtime_trap: `first(collect([0.0, 0.0, 0.0]))` :: Float64
...
repro(x::Float64) = first(collect([0.0, 0.0, 0.0]))
