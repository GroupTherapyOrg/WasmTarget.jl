...
kind: compile_error
construct: "compile_error: `signbit(exp(0.0f0))` :: Vector{Int64}→Bool"
...
# Gap `6b6396dd460e` — compile_error: `signbit(exp(0.0f0))` :: Vector{Int64}→Bool
...
repro(v::Vector{Int64}) = signbit(exp(0.0f0))
function _m(a, b)
...
error: func 6 failed to validate

Caused by:
    0: type mismatch: expected i64, found anyref (at offset 0xa3d)
```
