...
kind: wrong_value
construct: "wrong_value: `length(uppercase(reverse(\"héllo\")))` :: Int64"
...
# Gap `f1e62033d842` — wrong_value: `length(uppercase(reverse("héllo")))` :: Int64
...
repro(x::Int64) = length(uppercase(reverse("héllo")))
