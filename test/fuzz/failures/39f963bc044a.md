...
kind: wrong_value
construct: "wrong_value: `abs(Int64(0x01 << x))` :: Int64"
...
# Gap `39f963bc044a` — wrong_value: `abs(Int64(0x01 << x))` :: Int64
...
repro(x::Int64) = abs(Int64(0x01 << x))
...
## Diagnostic
```
at x=-9223372036854775808: native=0  wasm=1
```
