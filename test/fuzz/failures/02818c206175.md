...
kind: wrong_value
construct: "wrong_value: `mod(0.0, log(0.0)) <= 0.0` :: Vector{Int64}→Bool"
...
# Gap `02818c206175` — wrong_value: `mod(0.0, log(0.0)) <= 0.0` :: Vector{Int64}→Bool
...
repro(v::Vector{Int64}) = mod(0.0, log(0.0)) <= 0.0
function _m(a, b)
