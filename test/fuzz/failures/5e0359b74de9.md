...
construct: "divergent_throw: `abs(first(filter((y->false), [0.0, x, x])))` :: Float64"
location: "test/fuzz (generated)"
fn_name: repro
arg_types: "(Float64,)"
first_seen: sweep-2-d4
---

# Gap `5e0359b74de9` — divergent_throw: `abs(first(filter((y->false), [0.0, x, x])))` :: Float64
...
repro(x::Float64) = abs(first(filter((y->false), [0.0, x, x])))
...
## Diagnostic
```
at x=0.0: native=throw BoundsError  wasm=0
```
