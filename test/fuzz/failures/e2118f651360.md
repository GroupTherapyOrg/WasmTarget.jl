...
kind: wrong_value
construct: "wrong_value: `Float64(abs(Int8(1) << -9223372036854775808))` :: Float64"
...
# Gap `e2118f651360` — wrong_value: `Float64(abs(Int8(1) << -9223372036854775808))` :: Float64
...
repro(x::Float64) = Float64(abs(Int8(1) << -9223372036854775808))
_x = 0.0
_c = deepcopy(_x)
