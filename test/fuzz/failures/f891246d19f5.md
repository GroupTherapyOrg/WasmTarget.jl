...
kind: runtime_trap
construct: "runtime_trap: `any((y->isempty(Dict(\"\" => \"\", \"\" => \"\"))), [true, true, x])` :: Bool"
...
# Gap `f891246d19f5` — runtime_trap: `any((y->isempty(Dict("" => "", "" => ""))), [true, true, x])` :: Bool
...
repro(x::Bool) = any((y->isempty(Dict("" => "", "" => ""))), [true, true, x])
_x = true
_c = deepcopy(_x)
