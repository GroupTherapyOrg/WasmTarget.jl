...
kind: wrong_value
construct: "wrong_value: `if Int32(1) << -9223372036854775808 in [Int32(0), Int32(0), Int32(0)]\n    0.0\nelse\n    x\nend` :: Float64"
...
# Gap `575fc98ba3da` — wrong_value: `if Int32(1) << -9223372036854775808 in [Int32(0), Int32(0), Int32(0)]
    0.0
else
    x
end` :: Float64
...
repro(x::Float64) = if Int32(1) << -9223372036854775808 in [Int32(0), Int32(0), Int32(0)]
    0.0
else
    x
end
