...
kind: runtime_trap
construct: "runtime_trap: `length(Dict(Int32(0) => 0, sum([Int32(0), Int32(0), Int32(0)]) => x))` :: Int64"
...
# Gap `b85535ae7df7` — runtime_trap: `length(Dict(Int32(0) => 0, sum([Int32(0), Int32(0), Int32(0)]) => x))` :: Int64
...
repro(x::Int64) = length(Dict(Int32(0) => 0, sum([Int32(0), Int32(0), Int32(0)]) => x))
_x = 0
_c = deepcopy(_x)
...
## Triage — KNOWN LIMITATION sibling (P3 bugsmash)

Same class as 20775d3ec5b2/418e48316c5c/a70595550bd8/ef3c54645d9f:
heterogeneous-key Dict literal (Int32 literal key + Int64 computed key
promotes through dict_with_eltype → unparameterized Dict → runtime type
dispatch). See README Known Limitations; workaround: promote keys to one
concrete type.
