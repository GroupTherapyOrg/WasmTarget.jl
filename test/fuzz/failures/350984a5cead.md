...
kind: compile_error
construct: "compile_error: `if 0.0 == median([0, 0, 0])\n    0x00\nelse\n    0x00\nend` :: UInt8"
...
# Gap `350984a5cead` — compile_error: `if 0.0 == median([0, 0, 0])
    0x00
else
    0x00
end` :: UInt8
...
repro(x::UInt8) = if 0.0 == median([0, 0, 0])
    0x00
else
    0x00
end
...
Caused by:
    0: type mismatch: expected anyref, found i32 (at offset 0xebdc)
```
