...
construct: "divergent_throw: `abs(Float64(lcm(Int8(-128), Int8(127))))` :: Float64"
...
# Gap `7fa684d08b06` — divergent_throw: `abs(Float64(lcm(Int8(-128), Int8(127))))` :: Float64
...
repro(x::Float64) = abs(Float64(lcm(Int8(-128), Int8(127))))
_x = 0.0
_c = deepcopy(_x)
...
## Diagnostic
```
at x=0.0: native=throw OverflowError  wasm=16256
```
