...
kind: runtime_trap
construct: "runtime_trap: `Int8(0) in [Int8(0), Int8(0), Int8(0)]` :: Bool"
...
# Gap `fc7454877290` — runtime_trap: `Int8(0) in [Int8(0), Int8(0), Int8(0)]` :: Bool
...
repro(x::Bool) = Int8(0) in [Int8(0), Int8(0), Int8(0)]
_x = true
_c = deepcopy(_x)
