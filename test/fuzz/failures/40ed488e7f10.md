...
kind: wrong_value
construct: "wrong_value: `abs(Float64(~(Int8(0)) << length([0, 0, 0])))` :: Float64"
...
# Gap `40ed488e7f10` — wrong_value: `abs(Float64(~(Int8(0)) << length([0, 0, 0])))` :: Float64
...
repro(x::Float64) = abs(Float64(~(Int8(0)) << length([0, 0, 0])))
_x = 0.0
_c = deepcopy(_x)
...
## Diagnostic
```
at x=0.0: native=8.0  wasm=248.0
```
