...
kind: runtime_trap
construct: "runtime_trap: `getindex(Dict(0 => 0, 0 => 0), x) + length(string(1.0))` :: Int64"
...
# Gap `d8ccf279e314` — runtime_trap: `getindex(Dict(0 => 0, 0 => 0), x) + length(string(1.0))` :: Int64
...
repro(x::Int64) = getindex(Dict(0 => 0, 0 => 0), x) + length(string(1.0))
_x = 0
_c = deepcopy(_x)
