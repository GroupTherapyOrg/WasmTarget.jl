...
kind: compile_error
construct: "compile_error: `getindex(Dict(0 => 0.0, 0 => 0.0), 0)` :: Vector{Float64}→Float64"
...
# Gap `3b2dfc406980` — compile_error: `getindex(Dict(0 => 0.0, 0 => 0.0), 0)` :: Vector{Float64}→Float64
...
repro(v::Vector{Float64}) = getindex(Dict(0 => 0.0, 0 => 0.0), 0)
function _m(a, b)
...
Caused by:
    0: type mismatch: expected i64, found (ref $type) (at offset 0x3d0)
```
