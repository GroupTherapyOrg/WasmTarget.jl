...
construct: "divergent_throw: `if getindex([true, true, true], x)\n    0\nelse\n    0\nend` :: Int64"
...
# Gap `1bb69bcd36d4` — divergent_throw: `if getindex([true, true, true], x)
    0
else
    0
end` :: Int64
...
repro(x::Int64) = if getindex([true, true, true], x)
    0
else
    0
end
