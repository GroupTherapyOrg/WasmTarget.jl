...
kind: compile_error
construct: "compile_error: `Float64(0x0000 << length(Dict(\"\" => 0, \"\" => 0)))` :: Vector{Float64}→Float64"
...
# Gap `5734021bbd8b` — compile_error: `Float64(0x0000 << length(Dict("" => 0, "" => 0)))` :: Vector{Float64}→Float64
...
repro(v::Vector{Float64}) = Float64(0x0000 << length(Dict("" => 0, "" => 0)))
function _m(a, b)
...
Caused by:
    0: type mismatch: expected i64, found (ref null $type) (at offset 0x3a5)
```
