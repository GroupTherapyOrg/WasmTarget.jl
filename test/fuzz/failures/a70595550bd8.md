...
kind: runtime_trap
construct: "runtime_trap: `isempty(Dict(Int32(0) => 0, first(cumsum([Int32(0), Int32(0), Int32(0)])) => 0))` :: Bool"
...
# Gap `a70595550bd8` — runtime_trap: `isempty(Dict(Int32(0) => 0, first(cumsum([Int32(0), Int32(0), Int32(0)])) => 0))` :: Bool
...
repro(x::Bool) = isempty(Dict(Int32(0) => 0, first(cumsum([Int32(0), Int32(0), Int32(0)])) => 0))
_x = true
_c = deepcopy(_x)
