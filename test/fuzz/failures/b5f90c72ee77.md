...
kind: compile_error
construct: "compile_error: `0 + (0 + length(Dict(\"\" => \"\", \"\" => \"\")))` :: Vector{Int64}→Int64"
...
# Gap `b5f90c72ee77` — compile_error: `0 + (0 + length(Dict("" => "", "" => "")))` :: Vector{Int64}→Int64
...
repro(v::Vector{Int64}) = 0 + (0 + length(Dict("" => "", "" => "")))
function _m(a, b)
...
Caused by:
    0: type mismatch: expected i64, found (ref null $type) (at offset 0x390)
```
