...
function PlaygroundPage()
    ...
    Div(:class => "w-full -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8",
            ...
            Div(:class => "border border-stone-700 rounded-xl overflow-hidden shadow-lg",
            ...
            Div(:class => "mt-8 grid md:grid-cols-3 gap-6",
                ...
                # How it works
                Div(:class => "p-6 bg-stone-100 dark:bg-stone-800 rounded-xl",
                ...
                Div(:class => "p-6 bg-stone-100 dark:bg-stone-800 rounded-xl",
                    ...
                    Ul(:class => "text-stone-600 dark:text-stone-400 text-sm space-y-1",
                ...
                Div(:class => "p-6 bg-stone-100 dark:bg-stone-800 rounded-xl",
                    ...
                    Ul(:class => "text-stone-600 dark:text-stone-400 text-sm space-y-1",
                        Li(
                            Code(:class => "bg-stone-200 dark:bg-stone-700 px-1 rounded", "Ctrl"),
                            " + ",
                            Code(:class => "bg-stone-200 dark:bg-stone-700 px-1 rounded", "Enter"),
                            " - Run code"
                        ),
                        Li(
                            Code(:class => "bg-stone-200 dark:bg-stone-700 px-1 rounded", "Tab"),
                            " - Indent"
                        ),
                        Li(
                            Code(:class => "bg-stone-200 dark:bg-stone-700 px-1 rounded", "Ctrl"),
                            " + ",
                            Code(:class => "bg-stone-200 dark:bg-stone-700 px-1 rounded", "Z"),
                            " - Undo"
                        )
                    )
                )
            ...
            # Technical note
            Div(:class => "mt-6 p-4 bg-cyan-50 dark:bg-cyan-900/20 border border-cyan-200 dark:border-cyan-800 rounded-xl",
