...
function IntegersFloats()
    ManualLayout(chapter_id="integers-floats", chapter_title="Integers & Floats",
        ...
        Div(:class => "my-6 overflow-x-auto",
            Table(:class => "w-full text-sm border-collapse",
                Thead(:class => "bg-stone-100 dark:bg-stone-800",
                    Tr(
                        Th(:class => "text-left px-4 py-2 border border-stone-200 dark:border-stone-700 font-medium text-stone-700 dark:text-stone-300", "Type"),
                        Th(:class => "text-left px-4 py-2 border border-stone-200 dark:border-stone-700 font-medium text-stone-700 dark:text-stone-300", "Wasm"),
                        Th(:class => "text-left px-4 py-2 border border-stone-200 dark:border-stone-700 font-medium text-stone-700 dark:text-stone-300", "Bits"),
                        Th(:class => "text-left px-4 py-2 border border-stone-200 dark:border-stone-700 font-medium text-stone-700 dark:text-stone-300", "Range")
                    )
                ),
                Tbody(
                    Tr(
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 font-mono text-cyan-600 dark:text-cyan-400", "Int32"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 font-mono text-stone-500 dark:text-stone-400", "i32"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 text-stone-600 dark:text-stone-400", "32"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 text-stone-600 dark:text-stone-400", "-2,147,483,648 to 2,147,483,647")
                    ),
                    Tr(
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 font-mono text-cyan-600 dark:text-cyan-400", "Int64"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 font-mono text-stone-500 dark:text-stone-400", "i64"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 text-stone-600 dark:text-stone-400", "64"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 text-stone-600 dark:text-stone-400", "-9,223,372,036,854,775,808 to 9,223,372,036,854,775,807")
                    ),
                    Tr(
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 font-mono text-cyan-600 dark:text-cyan-400", "UInt32"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 font-mono text-stone-500 dark:text-stone-400", "i32"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 text-stone-600 dark:text-stone-400", "32"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 text-stone-600 dark:text-stone-400", "0 to 4,294,967,295")
                    ),
                    Tr(
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 font-mono text-cyan-600 dark:text-cyan-400", "UInt64"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 font-mono text-stone-500 dark:text-stone-400", "i64"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 text-stone-600 dark:text-stone-400", "64"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 text-stone-600 dark:text-stone-400", "0 to 18,446,744,073,709,551,615")
                    )
                )
            )
        ),
        ...
        P(:class => "text-stone-600 dark:text-stone-400 my-4",
            ...
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "Int"),
            " is an alias for ",
...
b::Int32 = a - 1        # Underflows to 2147483647""",
            ...
            Table(:class => "w-full text-sm border-collapse",
                Thead(:class => "bg-stone-100 dark:bg-stone-800",
                    Tr(
                        ...
                        Th(:class => "text-left px-4 py-2 border border-stone-200 dark:border-stone-700 font-medium text-stone-700 dark:text-stone-300", "Wasm"),
                        Th(:class => "text-left px-4 py-2 border border-stone-200 dark:border-stone-700 font-medium text-stone-700 dark:text-stone-300", "Bits"),
                        Th(:class => "text-left px-4 py-2 border border-stone-200 dark:border-stone-700 font-medium text-stone-700 dark:text-stone-300", "Precision")
                    )
                ),
                Tbody(
                    Tr(
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 font-mono text-cyan-600 dark:text-cyan-400", "Float32"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 font-mono text-stone-500 dark:text-stone-400", "f32"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 text-stone-600 dark:text-stone-400", "32"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 text-stone-600 dark:text-stone-400", "~7 decimal digits")
                    ),
                    Tr(
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 font-mono text-cyan-600 dark:text-cyan-400", "Float64"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 font-mono text-stone-500 dark:text-stone-400", "f64"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 text-stone-600 dark:text-stone-400", "64"),
                        Td(:class => "px-4 py-2 border border-stone-200 dark:border-stone-700 text-stone-600 dark:text-stone-400", "~15-17 decimal digits")
                    )
                )
            )
        ),
        ...
        P(:class => "text-stone-600 dark:text-stone-400 my-4",
            ...
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "Float32"),
            ", append ",
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "f0"),
            " to the literal: ",
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "3.14f0"),
            "."
        ),
        ...
        P(:class => "text-stone-600 dark:text-stone-400 mb-4",
            ...
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "div"),
            ...
            Div(:class => "flex items-start gap-3",
                ...
                Div(
                    ...
                    P(:class => "text-sm text-cyan-700 dark:text-cyan-300 mt-1",
                        ...
                        Code(:class => "text-cyan-600 dark:text-cyan-400", "round()"),
                        ", ",
                        Code(:class => "text-cyan-600 dark:text-cyan-400", "floor()"),
                        ", or ",
                        Code(:class => "text-cyan-600 dark:text-cyan-400", "ceil()"),
...
k = 2.5e-3     # Scientific: 0.0025""",
        ...
        Ul(:class => "list-disc list-inside space-y-2 text-stone-600 dark:text-stone-400 mb-6",
            Li(Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "Int32"), " and ", Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "Int64"), " for signed integers"),
            Li(Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "Float32"), " and ", Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "Float64"), " for floating-point numbers"),
            Li("Integer overflow wraps around silently - be mindful of value ranges"),
            Li("Use ", Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "div(a, b)"), " for integer division, ", Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "a % b"), " for remainder"),
            Li("Type constructors like ", Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "Float64(x)"), " convert between types"),
            Li("Support for decimal, hex (", Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "0x"), "), binary (", Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "0b"), "), and scientific notation")
        ),
