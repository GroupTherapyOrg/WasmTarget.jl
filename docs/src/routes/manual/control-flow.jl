...
function ControlFlow()
    ManualLayout(chapter_id="control-flow", chapter_title="Control Flow",
        ...
        P(:class => "text-lg text-stone-600 dark:text-stone-400 mb-8",
            ...
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "if"),
            "/",
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "else"),
            " for conditional execution, ",
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "while"),
            " and ",
        ...
        P(:class => "text-stone-600 dark:text-stone-400 mb-4",
            ...
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "elseif"),
...
sign(0)    # returns 0""",
        ...
        Div(:class => "p-4 bg-cyan-50 dark:bg-cyan-900/20 rounded-xl border border-cyan-200 dark:border-cyan-800 my-6",
            Div(:class => "flex items-start gap-3",
                ...
                Div(
                    P(:class => "text-sm text-cyan-800 dark:text-cyan-200 font-medium", "if as an Expression"),
                    P(:class => "text-sm text-cyan-700 dark:text-cyan-300 mt-1",
                        "In Julia, ",
                        Code(:class => "text-cyan-800 dark:text-cyan-200", "if"),
                        " returns a value: ",
                        Code(:class => "text-cyan-800 dark:text-cyan-200", "result = if x > 0 \"pos\" else \"non-pos\" end"),
                        ". This is equivalent to the ternary operator: ",
                        Code(:class => "text-cyan-800 dark:text-cyan-200", "x > 0 ? \"pos\" : \"non-pos\""),
                        "."
                    )
                )
            )
...
sum_to_n(100) # returns 5050""",
        ...
        P(:class => "text-stone-600 dark:text-stone-400 mb-4",
            ...
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "1:n"),
            " or a collection."
        ),
...
factorial(6)  # returns 720""",
        ...
        P(:class => "text-stone-600 dark:text-stone-400 my-4",
            ...
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "1:5"),
            " includes 1, 2, 3, 4, and 5. You can also specify a step: ",
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "1:2:10"),
            " gives 1, 3, 5, 7, 9."
        ),
...
# a || b: if a is true, return true without evaluating b""",
        ...
        Div(:class => "p-4 bg-stone-100 dark:bg-stone-800 rounded-xl my-6",
            H3(:class => "text-sm font-semibold text-stone-800 dark:text-stone-200 mb-3", "Common Short-Circuit Idioms"),
            Div(:class => "space-y-2 text-sm font-mono",
                P(:class => "text-stone-600 dark:text-stone-400",
                    Code(:class => "text-cyan-600 dark:text-cyan-400", "condition && action()"),
                    Span(:class => "text-stone-500 ml-2", "# execute action only if condition is true")
                ),
                P(:class => "text-stone-600 dark:text-stone-400",
                    Code(:class => "text-cyan-600 dark:text-cyan-400", "condition || action()"),
                    Span(:class => "text-stone-500 ml-2", "# execute action only if condition is false")
                ),
                P(:class => "text-stone-600 dark:text-stone-400",
                    Code(:class => "text-cyan-600 dark:text-cyan-400", "x != 0 && do_something(x)"),
                    Span(:class => "text-stone-500 ml-2", "# guard against zero")
                )
            )
        ),
        ...
        P(:class => "text-stone-600 dark:text-stone-400 mb-4",
            ...
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "throw"),
            " an exception when an error occurs, and ",
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "try"),
            "/",
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "catch"),
...
function compute_sqrt(n::Int32)::Int32
    try
        ...
        P(:class => "text-stone-600 dark:text-stone-400 mb-4",
            "Inside loops, ",
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "break"),
            " exits the loop immediately, while ",
            Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "continue"),
...
find_divisible()  # returns 21""",
        ...
        Ul(:class => "list-disc list-inside space-y-2 text-stone-600 dark:text-stone-400 mb-6",
            Li(Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "if"), "/", Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "elseif"), "/", Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "else"), " for conditional execution; ", Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "if"), " is an expression that returns a value"),
            Li(Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "while condition ... end"), " repeats while condition is true"),
            Li(Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "for i in range ... end"), " iterates over a sequence (e.g., ", Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "1:10"), ")"),
            Li(Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "&&"), " short-circuits on false; ", Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "||"), " short-circuits on true"),
            Li(Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "try"), "/", Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "catch"), " handles exceptions; ", Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "throw"), " raises them"),
            Li(Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "break"), " exits a loop; ", Code(:class => "text-cyan-600 dark:text-cyan-400 bg-stone-100 dark:bg-stone-800 px-1.5 py-0.5 rounded", "continue"), " skips to the next iteration")
        ),
