() -> begin
    ...
    PageWithTOC(sections, Div(:class => "space-y-10",
        ...
        Table(:class => table_cls,
            Thead(Tr(Th(:class => th_cls, "Julia Type"), Th(:class => th_cls, "WASM Type"), Th(:class => th_cls, "Notes"))),
            Tbody(
                Tr(Td(:class => td_cls, Code(:class => code_inline, "String")), Td(:class => td_cls, "WasmGC ", Code(:class => code_inline, "array(i32)")), Td(:class => td_cls, "One i32 per character (Unicode codepoints)")),
