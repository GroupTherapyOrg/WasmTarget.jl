...
divide(a::Int32, b::Int32)::Int32 = div(a, b)""",
    ...
    return result
        ...
        Div(:class => "py-16 mt-8",
            H2(:class => "text-2xl font-bold text-center text-stone-800 dark:text-stone-100 mb-4",
                "Advanced Examples"
            ),
            P(:class => "text-center text-stone-500 dark:text-stone-400 mb-8 max-w-2xl mx-auto",
            ...
            Div(:class => "max-w-4xl mx-auto bg-white dark:bg-stone-800 rounded-2xl p-8 mb-8",
                Div(:class => "flex items-start justify-between mb-4 flex-wrap gap-2",
                    ...
                    A(:href => "https://github.com/GroupTherapyOrg/WasmTarget.jl/blob/main/test/runtests.jl#L1455",
                      :class => "text-xs text-cyan-500 hover:text-cyan-600 dark:text-cyan-400 flex items-center gap-1",
                      :target => "_blank",
                ...
                Pre(:class => "bg-stone-800 dark:bg-stone-900 rounded-xl p-4 overflow-x-auto text-sm",
                    Code(:class => "text-stone-100 font-mono", """# WASM globals serve as reactive state (like Signals)
mod = WasmModule()
...
add_export!(mod, "increment", 0, func_idx)""")
                ...
                P(:class => "text-stone-500 dark:text-stone-400 text-xs mt-4",
            ...
            Div(:class => "max-w-4xl mx-auto bg-white dark:bg-stone-800 rounded-2xl p-8",
                Div(:class => "flex items-start justify-between mb-4 flex-wrap gap-2",
                    Div(
                        H3(:class => "text-xl font-bold text-stone-800 dark:text-stone-100",
                            "Low-Level Builder API"
                ...
                Pre(:class => "bg-stone-800 dark:bg-stone-900 rounded-xl p-4 overflow-x-auto text-sm",
                    Code(:class => "text-stone-100 font-mono", """# Tables for function references (dynamic dispatch)
mod = WasmModule()
