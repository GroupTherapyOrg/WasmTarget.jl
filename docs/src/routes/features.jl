...
#
# These are Therapy.jl islands that run pre-compiled WASM.
# Each demo loads a specific .wasm file and provides interactive inputs.
# =============================================================================
...
ArithmeticDemo = island(:ArithmeticDemo) do
    ...
    # Results computed via pre-compiled WASM (simulated for now)
    add_result = () -> a() + b()
    mul_result = () -> a() * b()
