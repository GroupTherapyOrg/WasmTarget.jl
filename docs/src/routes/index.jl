    ...
    Div(:class => "space-y-16",
        ...
        Div(:class => "text-center space-y-6 pt-8",
            ...
            P(:class => "text-lg text-warm-600 dark:text-warm-400 max-w-2xl mx-auto leading-relaxed",
                ...
                A(:href => "https://github.com/GroupTherapyOrg/Snapshot.jl", :target => "_blank", :class => "text-accent-500 hover:text-accent-600 underline", "Snapshot.jl"),
                "."
            ),
            Div(:class => "flex flex-wrap gap-4 justify-center pt-4",
                ...
                A(:href => "https://grouptherapyorg.github.io/Snapshot.jl/", :target => "_blank",
